#!/usr/bin/env python3
"""版本存档与回滚管理器（逝者 Skill：备份 life.md）
...
CORE_FILES = ["life.md", "persona.md", "SKILL.md", "meta.json"]
...
def main():
    parser = argparse.ArgumentParser(description="逝者 Skill 版本管理器")
    parser.add_argument("--action", required=True, choices=["backup", "rollback", "list"])
    parser.add_argument("--slug", required=True, help="逝者代号 slug")
    parser.add_argument(
        "--base-dir",
